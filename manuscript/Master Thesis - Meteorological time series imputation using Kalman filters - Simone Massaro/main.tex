...
\titleformat{\subsubparagraph}[runin]{\normalfont\normalsize \bfseries\itshape}{\thesubsubparagraph}{1em}{}
...
\usepackage{titlesec}
\titleclass{\sssparagraph}{straight}[\subsubparagraph]
\newcounter{sssparagraph}
\renewcommand{\thesssparagraph}{\Alph{sssparagraph}}
\titleformat{\sssparagraph}[runin]{\normalfont\normalsize\itshape}{\thesssparagraph}{1em}{}
\titlespacing*{\sssparagraph} {\parindent}{3.25ex plus 1ex minus .2ex}{1em}
\makeatletter
\def\toclevel@sssparagraph{7}
\makeatother
%%% ===
