...
# %% auto 0
__all__ = ['PosDef', 'is_posdef', 'is_posdef2', 'check_posdef', 'KalmanFilter']
...
# %% ../../lib_nbs/kalman/00_Kalman_Filter.ipynb 17
def is_posdef(cov):
...
def check_posdef(cov, error=True):
...
# %% ../../lib_nbs/kalman/00_Kalman_Filter.ipynb 52
...
def _filter_predict(transition_matrix, transition_cov,
    ...
    if not is_posdef(pred_state_cov):
        state = {
            'transition_matrix': transition_matrix,
            'current_state_cov': current_state_cov,
            'transition_cov': transition_cov,
            'pred_state_cov': pred_state_cov
        }
        
        filename = f"pred_state_cov_posdef_{datetime.now()}"
        print(f"error with posdef saving to {filename}")
...
# %% ../../lib_nbs/kalman/00_Kalman_Filter.ipynb 62
...
# %% ../../lib_nbs/kalman/00_Kalman_Filter.ipynb 71
@torch.no_grad()
@patch
...
# %% ../../lib_nbs/kalman/00_Kalman_Filter.ipynb 101
@patch
...
# %% ../../lib_nbs/kalman/00_Kalman_Filter.ipynb 105
@patch
...
# %% ../../lib_nbs/kalman/00_Kalman_Filter.ipynb 116
@patch
