...
# %% auto 0
__all__ = ['path_r', 'rmse_mask', 'var_type', 'method_type', 'method_scale', 'meteo_scale', 'renames_table_latex',
           'renames_table_latex_stand', 'err_type', 'PredictLossVar', 'PredictLikelihoodVar', 'MultiMetrics',
           'KalmanImputation', 'KalmanImputationVar', 'importr_install', 'setupR', 'pd2R', 'R2pd', 'add_buffer',
           'item2REddy', 'gap_fill_item', 'MDSImputation', 'ERAImputation', 'MaskedMetric', 'rmse', 'normalize',
           'NormalizedMetric', 'gaplen2hours', 'prep_df', 'timeseriesAgg', 'RMSEAgg', 'ImpComparison', 'l_model',
           'KalmanImpComparison', 'facet_wrap', 'facet_grid', 'the_plot', 'the_plot_stand', 'the_plot_stand2',
           'custom_boxplot_nooutlier', 'the_plot_stand3', 'agg_gap_len', 'plot_gap_len', 'plot_compare', 'plot_control',
           'plot_control_loss', 'plot_control_lh', 'plot_other_var', 'plot_generic', 'unnest_predictions',
           'plot_timeseries', 'highlight_min_method', 'style_the_table', 'the_table', 'the_table_latex',
           'table_compare', 'table_compare_latex', 'table_compare3', 'table_compare3_latex', 'table_gap_len',
           'table_gap_len_latex']

# %% ../../lib_nbs/20_results.ipynb 5
...
# %% ../../lib_nbs/20_results.ipynb 83
rmse_mask = MaskedMetric(rmse)

# %% ../../lib_nbs/20_results.ipynb 94
import random
import polars as pl
from tqdm.auto import tqdm

# %% ../../lib_nbs/20_results.ipynb 96
...
# %% ../../lib_nbs/20_results.ipynb 118
def l_model(x): return torch.load(base_path / x)

# %% ../../lib_nbs/20_results.ipynb 121
...
# %% ../../lib_nbs/20_results.ipynb 186
def l_model(x): return torch.load(base_path / x)

# %% ../../lib_nbs/20_results.ipynb 194
