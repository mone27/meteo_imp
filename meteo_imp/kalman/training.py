# AUTOGENERATED! DO NOT EDIT! File to edit: ../../lib_nbs/11_training.ipynb.
...
# %% ../../lib_nbs/11_training.ipynb 10
from dominate.tags import *

# %% ../../lib_nbs/11_training.ipynb 11
@patch
...
# %% ../../lib_nbs/11_training.ipynb 28
def _rename_lag(lag):
    def _inner(col_name):
        return f"{col_name}_lag_{lag}"
    return _inner

# %% ../../lib_nbs/11_training.ipynb 30
def _lag_df(df, lag):
    "add lagged columns"
...
# %% ../../lib_nbs/11_training.ipynb 64
hai_control = {'TA_ERA': 'TA', 'SW_IN_ERA': 'SW_IN', 'VPD_ERA': 'VPD'}

# %% ../../lib_nbs/11_training.ipynb 69
import altair as alt
from altair import datum

# %% ../../lib_nbs/11_training.ipynb 70
def def_selection():
    return alt.selection_interval(bind="scales")

# %% ../../lib_nbs/11_training.ipynb 72
...
# %% ../../lib_nbs/11_training.ipynb 128
from ..utils import *
from fastai.torch_core import to_cpu

from torch import Tensor

# %% ../../lib_nbs/11_training.ipynb 129
...
# %% ../../lib_nbs/11_training.ipynb 178
from fastai.data.transforms import *

# %% ../../lib_nbs/11_training.ipynb 181
import numpy as np

# %% ../../lib_nbs/11_training.ipynb 182
def gen_shifts(var):
    """ Generate shifts for a random distribution with variances var"""
    while True:
        yield int(np.random.randn() * var)

# %% ../../lib_nbs/11_training.ipynb 184
...
# %% ../../lib_nbs/11_training.ipynb 219
from .filter import *
from torch.distributions import MultivariateNormal

# %% ../../lib_nbs/11_training.ipynb 226
@patch
...
# %% ../../lib_nbs/11_training.ipynb 272
from sklearn.metrics import r2_score, mean_squared_error

# %% ../../lib_nbs/11_training.ipynb 284
from fastai.metrics import *

# %% ../../lib_nbs/11_training.ipynb 294
from fastai.learner import AvgMetric
import torch.nn.functional as F

# %% ../../lib_nbs/11_training.ipynb 295
...
# %% ../../lib_nbs/11_training.ipynb 428
from ipywidgets import IntSlider, interact_manual, Text

# %% ../../lib_nbs/11_training.ipynb 429
...
# %% ../../lib_nbs/11_training.ipynb 436
from ipywidgets import widgets, HBox, VBox
from typing import Sequence

# %% ../../lib_nbs/11_training.ipynb 437
