# AUTOGENERATED! DO NOT EDIT! File to edit: ../lib_nbs/00_Gaussian.ipynb.

# %% auto 0
__all__ = ['ListNormal', 'Normal', 'ListMNormal', 'MNormal', 'softplus', 'to_posdef', 'is_symmetric', 'symmetric_upto',
           'symmetric_upto_batched', 'is_posdef', 'is_posdef_eigv', 'inv_softplus', 'batch_diagonal',
           'batch_diag_scatter', 'batch_diag_embed', 'PosDef', 'CheckPosDef', 'DiagPosDef', 'to_diagposdef',
           'conditional_guassian', 'cond_gaussian_batched', 'cov2std']

# %% ../lib_nbs/00_Gaussian.ipynb 5
from collections import namedtuple
from dataclasses import dataclass
from fastcore.basics import patch
from torch import Tensor

# %% ../lib_nbs/00_Gaussian.ipynb 8
...
# %% ../lib_nbs/00_Gaussian.ipynb 42
from fastcore.foundation import docs
from fastcore.basics import store_attr

# %% ../lib_nbs/00_Gaussian.ipynb 44
def inv_softplus(x):
    return x + torch.log(-torch.expm1(-x))
softplus = torch.nn.Softplus()

# %% ../lib_nbs/00_Gaussian.ipynb 45
...
# %% ../lib_nbs/00_Gaussian.ipynb 109
from warnings import warn
from fastcore.basics import store_attr

# %% ../lib_nbs/00_Gaussian.ipynb 110
class CheckPosDef():
    def __init__(self,
