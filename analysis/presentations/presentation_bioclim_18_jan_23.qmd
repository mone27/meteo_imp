...
base_path <- here::here("presentations/plots_18_jan/")
...
![plot of distribution of small gaps (<200) for all `TA`, `SW_IN` and `VPD` for all sites](plots_18_jan/gap_len_dist_small.png)
